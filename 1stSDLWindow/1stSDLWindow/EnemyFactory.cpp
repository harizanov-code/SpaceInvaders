...
void EnemyFactory::initialize() {
    ...
    enemyConfigs[EnemyType::SMALL] = { "Pictures/Enemies/Enemy_Level1_Cloud.png","Pictures/Bullet_2_Enemy.png" ,20, 10, 3.0f, 1.0f };
    enemyConfigs[EnemyType::MEDIUM] = { "Pictures/Enemies/Enemy_Level2_Bee.png","Pictures/Enemies/Projectiles/Bee_Projectile_1.png" ,40, 20, 2.5f, 0.8f};
    enemyConfigs[EnemyType::LARGE] = { "Pictures/Enemies/Enemy_Level3_Bean.png","Pictures/Enemies/Projectiles/Bean_Projectile_1.png", 80, 30, 2.0f, 0.6f };
    enemyConfigs[EnemyType::BOSS] = { "Pictures/Enemies/Enemy_Boss_Eye_1.png", "Pictures/Enemies/Projectiles/Eye_Boss_Projectile_1.png",200, 50, 1.5f, 0.4f };
}
